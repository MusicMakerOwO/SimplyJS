...
/**
 * Fluent builder for a select menu that picks from a server's channels, validating limits as
 * they're set. The builder *is* a {@link ChannelSelect} payload, so it can be sent as-is.
 */
